...
- `npm run smoke` starts a temporary local copy and checks login, staff roles, public applications, payment/card setup links, messaging permissions, state write guards, and payment API guards.
