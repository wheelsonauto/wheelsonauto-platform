...
async function run() {
  ...
  [
    ...
    'lastAccountTransfersCapability',
    'lastAccountRequirementsPendingVerificationCount',
    ...
    'card_setup_failed',
    'recordPublicCardSetupFailure',
    'No card was saved and no payment was charged',
    'recordPublicCheckoutFailure',
