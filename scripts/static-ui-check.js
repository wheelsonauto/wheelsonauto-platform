...
assertIncludes('Operational assignment failure review path', app, ['function liveLaunchJobAssignmentVehicleId', 'has active records for multiple customers:', 'Review assignment', 'data-action="resolve-assignment-conflict"', 'data-action="resolve-job-error"']);
