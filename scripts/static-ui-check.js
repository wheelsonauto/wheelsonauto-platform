...
assertIncludes('Multi-identity assignment progress UI', app, ['function assignmentAliasConnected', 'function assignmentNextUnlinkedPair', 'this review stays open and selects the next unresolved pair', 'Continue customer-name review', 'Another customer name or Clover reference still needs review.', 'Resolved name-link audit']);
