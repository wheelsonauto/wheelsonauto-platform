...
const anonymousProtectedRoutes = [
  ...
  ['POST', '/api/onboarding/links', 'Onboarding link administration'],
  ['POST', '/api/onboarding/review', 'Onboarding approval and denial'],
  ['POST', '/api/card-setup-requests', 'Saved-card setup administration'],
  ['POST', '/api/card-setup-requests/delete', 'Saved-card setup deletion'],
  ['POST', '/api/payment-links', 'Customer payment-link administration'],
  ['GET', '/api/messages/status', 'Messaging staff status'],
  ['POST', '/api/messages/ai-action', 'Star approval action'],
  ['POST', '/api/messages/ai-health', 'Star provider health test'],
  ['POST', '/api/notifications/email/test', 'Email provider delivery test'],
  ...
  ['POST', '/api/verification/document', 'Private document verification'],
  ...
  ['POST', '/api/integrations/stripe/readiness', 'Stripe live-account readiness'],
  ['POST', '/api/integrations/payments/manual-charge', 'Provider-aware saved-card charge'],
  ['POST', '/api/integrations/payments/refunds/prepare', 'Refund preparation'],
  ['POST', '/api/integrations/payments/refunds/execute', 'Refund execution'],
  ['POST', '/api/integrations/payments/refunds/complete-manual', 'Manual refund completion'],
  ['POST', '/api/integrations/payments/disputes/action', 'Dispute evidence and outcome action'],
  ['POST', '/api/integrations/telnyx/readiness', 'Telnyx live readiness'],
  ...
  ['POST', '/api/payment-provider/duplicate-review/resolve', 'Duplicate billing-period owner review'],
  ...
  ['POST', '/api/system/infrastructure/state-backup/verify', 'Encrypted state backup verification'],
  ['POST', '/api/system/launch-readiness/tasks', 'Launch-readiness task administration'],
