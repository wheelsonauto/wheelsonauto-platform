...
const matrix = [
  ...
  ['optional Telnyx adapter signed inbound, delivery, 10DLC, and number assignment', 'scripts/telnyx-messaging-check.js'],
  ['first-party customer-app messaging, privacy, PWA, and Star delivery', 'scripts/first-party-messaging-check.js'],
