...
assert(shell.includes("manager: new Set(['dashboard', 'fleet', 'customers', 'applications', 'messages', 'dispatch', 'maintenance', 'reports', 'more', 'settings', 'rental'])"), 'Manager workspace access must exclude owner Payments, Accounting, and Systems.');
