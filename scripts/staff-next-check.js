...
assert(customerPaymentAction.includes('One controlled Stripe test') && customerPaymentAction.includes('rapid autocharge turns off after the result'), 'Rapid schedule controls must explain that the live Stripe verification makes one attempt and then turns itself off.');
