...
[
  ...
  'Portal messages',
  'Proof uploads',
  'Customer portal access is scoped',
  ...
  'Vehicle identity',
  'vehicle_identity',
  'Daily closeout signoff',
  'daily_closeout_signoff',
  'dailyCloseoutSignoffGap',
  'Service identity',
  'service_identity',
  'serviceIdentityGapRows',
  ...
  'ifleet_function_coverage',
  'ifleetFunctionCoverageRows',
  'syncIfleetCoverageDispatchTasks',
  'Setup needed',
  'Missing contact',
  'Insurance proof',
  'Background checks',
  ...
  '/api/system/health',
  '/api/system/ifleet-coverage/tasks',
  'systemHealthSnapshot',
  'vehicle_assignment_conflict',
  'Dispatch from readiness',
  'create-readiness-task',
  'create-all-readiness-tasks',
  'readinessTaskPayload',
  'Readiness: ',
...
[
  ...
  'create-all-launch-proof-tasks',
  'launchProofTaskExists',
  'No new launch proof tasks needed',
  'Launch proof task added to Dispatch',
  'launchProofDispatchBoard',
  'Launch work queue',
  'iFleet-style proof gaps that can be turned into Dispatch work orders',
...
[
  ...
  'customerVehicleTextGapRows',
  'applicationHandoffGapRows',
  'documentExpirationReviewRows',
  'vehicleIdentityGapRows',
  'dailyCloseoutSignoffGap',
  'serviceIdentityGapRows',
  'claimEvidenceGapRows',
  'companyScopeGapRows',
  "vehicle_assignment_conflict', 'Vehicle assignment conflicts'",
  "customer_vehicle_text', 'Customer vehicle text'",
  "application_handoff', 'Application handoff'",
  "document_expiration', 'Document expiration'",
  "vehicle_identity', 'Vehicle identity'",
  "daily_closeout_signoff', 'Daily closeout signoff'",
  "service_identity', 'Service identity'",
  "claim_evidence', 'Claim evidence'",
  "company_scope', 'Company scope'",
  "ifleet_function_coverage', 'iFleet function coverage'",
...
[
  ...
  'apiProviderTruthOverrides',
  "id: 'star-ai'",
  'Blocked - 10DLC approval',
  ...
  'WOA_MESSAGING_WEBHOOK_SECRET',
  'clover_webhook_secret',
	  'Clover Hosted Checkout signing secret',
	  'CLOVER_APP_AUTH_CODE',
	  'CLOVER_WEBHOOK_SECRET',
