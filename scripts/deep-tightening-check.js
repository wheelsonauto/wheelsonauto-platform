...
[
  ...
  ['Rental File lifecycle', ['scripts/rental-file-check.js']],
  ['authenticated live event stream', ['scripts/live-event-stream-check.js']],
  ['production startup gate', ['scripts/production-startup-gate-check.js']],
  ['PostgreSQL SQL contracts', ['scripts/state-repository-sql-contract-check.js']],
  ['secret hygiene', ['scripts/secret-hygiene-check.js']],
  ['CLI migration arguments', ['scripts/cli-argument-check.js']],
  ...
  ['Star typed tools', ['scripts/star-tools-check.js']],
  ...
  ['React staff Messages module', ['scripts/staff-next-check.js']],
