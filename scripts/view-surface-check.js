...
assertIncludes('Star QA manager suggestions', starQaManager, ['Star QA manager', 'Fix first', 'Contact failed-twice customers', 'Review dispute matches', 'Review toll/violation recovery', 'Finish API provider readiness', 'Resolve vehicle assignment conflicts', 'Link autopay to vehicles', 'Clear verification inbox', 'Create customer portal logins', 'Follow up open payment links', 'Verify customer uploads', 'Review today sensitive changes', 'Follow up card setup links', 'Approve pending Star work', 'card setup/change link(s) are still waiting', 'need admin approval or human review']);
assertIncludes('Star QA fallback report export', starExport + app, ['Customer portal access', 'missingCustomerPortalRecords', 'Toll/violation recovery', 'tollReview', 'API provider readiness', 'apiReview', 'Messaging webhook secret', 'Clover webhook secret', 'webhookSecretConfigured', 'need customer/vehicle/plate review before charge or message']);
