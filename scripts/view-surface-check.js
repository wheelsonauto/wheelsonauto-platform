...
assertIncludes('Stripe owner activation handoff', app + server, ['Stripe account activation', 'Stripe activation is not complete yet', 'Finish Stripe business onboarding and required verification', 'Stripe has not enabled live charges', 'Stripe has not enabled live payouts', 'Card payments capability', 'Transfers capability', 'Account requirements', 'pending verification', 'current configuration', 'Safe check only', 'one matched signed live Stripe event', 'one signed live Stripe Identity verification', 'Open Stripe account', 'Check again']);
