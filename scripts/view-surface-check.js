...
assertIncludes('API provider launch queue', apiProviderLaunchItems + apiProviderLaunchQueue + app + css, ['Provider launch queue', 'API work order list', 'Search providers by Clover, SMS, email, EZPass', 'Choose provider, collect credentials', 'Run controlled live test and save result', 'API must match:', 'Next:', 'open-api-provider', 'create-api-task', 'api-provider-launch-queue', 'api-provider-launch-grid', 'api-provider-launch-card']);
...
assertIncludes('Tolls command view', tollsView + app + css, ['Toll recovery command', 'Open recovery', 'Match review', 'Ready to collect', 'EZPass API', 'Accounting', 'Search tolls by customer', 'toll-recovery-list', 'toll-recovery-card', 'new-toll-import', 'new-toll', 'send-claim-link', 'mark-claim-paid', 'Provider setup', 'Star can draft toll/violation messages']);
