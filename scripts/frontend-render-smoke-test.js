...
function ownerSmoke() {
  ...
  const launchAssignmentReview = context.liveLaunchPreflightModal({
    ...
    assignmentConflicts: [
      { vehicleId: 'veh-owner-resolver-reachability', vehicle: '2025 Resolver Reachability', vin: 'RESOLVERREACHVIN', plate: 'RES-OLVE', claimedBy: 'Resolver Primary / Resolver Alias', sources: ['WheelsonAuto autopay', 'Customer file'] },
