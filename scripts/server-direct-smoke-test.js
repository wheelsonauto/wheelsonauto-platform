...
async function main() {
  ...
  try {
    ...
    assert(ownerLaunchPreflight.json.assignmentConflictCount === ownerLaunchPreflight.json.structuralAssignmentConflictCount + ownerLaunchPreflight.json.assignmentReviewWarningCount, 'Transactional and owner-review assignment counts must reconcile to the complete conservative launch-blocking count.');
