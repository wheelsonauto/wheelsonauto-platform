...
async function main() {
  ...
  assert(!forgedLaunchState.integrations.clover.lastRecurringPlanSyncAt && !forgedLaunchState.integrations.clover.lastRecurringRosterCoverage && !forgedLaunchState.integrations.clover.lastRecurringVerifiedSubscriptionIds, 'A browser save must not create a fake fresh Clover roster or subscription snapshot.');
