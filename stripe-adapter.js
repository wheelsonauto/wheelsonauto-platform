...
function stripeClient(options = {}) {
  ...
  return {
    ...
    createCustomer: (payload, idempotencyKey, requestOptions = {}) => request('POST', '/customers', payload, { ...requestOptions, idempotencyKey }),
    createSetupCheckoutSession: (payload, idempotencyKey, requestOptions = {}) => request('POST', '/checkout/sessions', payload, { ...requestOptions, idempotencyKey }),
    ...
    createPaymentIntent: (payload, idempotencyKey, requestOptions = {}) => request('POST', '/payment_intents', payload, { ...requestOptions, idempotencyKey }),
