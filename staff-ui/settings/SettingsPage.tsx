...
export function SettingsPage({ role, theme, onThemeChange, onNavigate }: { role: 'owner' | 'manager' | 'mechanic'; theme: StaffTheme; onThemeChange: (theme: StaffTheme) => void; onNavigate: (workspace: string) => void }) {
