...
const emptyPortal: CustomerPortal = {
  account: {}, summary: {}, application: {}, applications: [], onboardingSessions: [], availableVehicles: [], customer: {}, contract: {}, recurring: {}, vehicle: {}, vehicles: [], payments: [], maintenance: [], claims: [], messages: [], documents: [], paymentRequests: [], cardSetupRequests: [], returnAppointments: [], generatedAt: ''
};
...
function VehiclePage({ portal }: { portal: CustomerPortal }) {
  ...
  const returns = portal.returnAppointments.slice().sort((a, b) => recordTime(b) - recordTime(a));
  return <main className="customer-page">
